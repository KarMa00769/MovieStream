...
import { getLocalMovie, uploadMovieVideo, type LocalMovieResponse } from '../services/api';
                  ...
                  <div className="row">
                    ...
                    <div className="col-md-8 px-md-4 d-flex flex-column justify-content-center">
                      <div className="d-flex align-items-center mb-3">
                        <span className="text-warning fw-bold fs-3 me-3">&starf; {movie.imdbRating} <span className="text-secondary fs-6">/ 10</span></span>
